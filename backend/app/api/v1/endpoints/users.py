...
def delete_user(
    ...
    db.execute(text("UPDATE submissions SET crop_reviewer_id=NULL WHERE crop_reviewer_id=:uid"), {"uid": user_id})
    db.execute(text("UPDATE submissions SET rrop_reviewer_id=NULL WHERE rrop_reviewer_id=:uid"), {"uid": user_id})
    db.execute(text("UPDATE submissions SET hq_compiled_by_id=NULL WHERE hq_compiled_by_id=:uid"), {"uid": user_id})
    ...
    db.execute(text("UPDATE notifications SET target_user_id=NULL WHERE target_user_id=:uid"), {"uid": user_id})
